<?php
  ...
  if(!empty($_GET['cod']))
  {
    ...
    include_once('config.php');
    $cod = $_GET['cod'];
    $sqlselect = "SELECT * FROM meta_trabalho WHERE cod=$cod";
...
<body className='snippet-body' style="background-color:#f8f9fa">
  <body id="body-pd">
    ...
    <main class="mdl-layout__content">
        ...
        <p style="color:#000;">cadastro de metas em relação à trabalho</b></p>
        <?php
        ...
        <div class="topo">
          <form action="save_meta_trabalho.php" method="post" name="forms">
        ...
        <dialog>
          <h2 id='titulo_dialog'>Meta sobre trabalho</h2>
            <?php //echo "<p>$meta</p>"; ?>
...
-->
    ...
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_metatrabalho.php?cod=<?php echo $cod?>";
...
function eliminaMeta2 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta2trabalho.php?cod=<?php echo $cod?>";
...
function eliminaMeta3 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta3trabalho.php?cod=<?php echo $cod?>";
...
function eliminaMeta4 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta4trabalho.php?cod=<?php echo $cod?>";
...
function eliminaMeta5 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta5trabalho.php?cod=<?php echo $cod?>";
