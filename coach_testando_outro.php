<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $result= mysqli_query($conexao_forms15, "INSERT INTO outro_12_meses(obs_andre) 
    VALUES ('$obs_andre')");
  ...
  <header class="header" id="header">
    ...
    <br><br>
      ...
      <?php
        ...
        echo"<form action='save_obsAndre_outro.php' method='post' name='forms'>";
      ?>
      <div class="mb-3">
...
<div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <label for="characters">Quantidade de caracteres: 490/ </label><span id="characters"></span><br>
      </div>
