...
if (isset($_POST['submit'])) {
  ...
  include_once('config.php');
    ...
    $resultSaude= mysqli_query($conexao_formsSaude,"INSERT INTO outro_12_meses(oque,porquem,onde,quando,porque,como,nome,sobrenome,objet,opcao,responsa,data_inicio,data_fim,obs) 
