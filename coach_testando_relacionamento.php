<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $result= mysqli_query($conexao_forms15, "INSERT INTO relacionamento_12_meses(obs_andre) 
    VALUES ('$obs_andre')");
  ...
  <header class="header" id="header">
    ...
    <br><br>
      ...
      <?php
        ...
        echo"<form action='save_obsAndre_relacionamento.php' method='post' name='forms'>";
      ?>
      <div class="mb-3">
