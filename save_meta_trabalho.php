...
/*
        ...
        $result2 = $conexao_forms15->query($sqlselect);
            ...
            if($meta1==''){
                 $sqlupdate = "UPDATE meta_trabalho SET meta1='$meta' 
                WHERE cod='$cod' ";
                $result = $conexao_forms15->query($sqlupdate);
            } else if($meta1!='' && $meta2=='') {
                $sqlupdate = "UPDATE meta_trabalho SET meta2='$meta' 
                WHERE cod='$cod' ";
                $result = $conexao_forms15->query($sqlupdate);
            }else if($meta1!='' && $meta2!='' && $meta3==''){
                 $sqlupdate = "UPDATE meta_trabalho SET meta3='$meta' 
                WHERE cod='$cod' ";
                $result = $conexao_forms15->query($sqlupdate);
            }else if ($meta1!='' && $meta2!='' && $meta3!='' && $meta4==''){
                 $sqlupdate = "UPDATE meta_trabalho SET meta4='$meta' 
                WHERE cod='$cod' ";
                $result = $conexao_forms15->query($sqlupdate);
            }else if ($meta1!='' && $meta2!='' && $meta3!='' && $meta4!='' && $meta5==''){
                 $sqlupdate = "UPDATE meta_trabalho SET meta5='$meta' 
                WHERE cod='$cod' ";
                $result = $conexao_forms15->query($sqlupdate);
            }
    }
