...
if (isset($_POST['submit'])) {
  ...
  $resultSaude= mysqli_query($conexao_formsSaude,"INSERT INTO dinheiro_12_meses(oque,porquem,onde,quando,porque,como,nome,sobrenome,objet,opcao,responsa,data_inicio,data_fim,obs) 
