...
insert  into db_coach.cadastro values ("Bruno","bruno@gmail.com",123456,"Brasilia","DF",61999999999,"masculino",1);
insert  into db_coach.tb_login values ("bruno@gmail.com",123456,1);
select*from db_coach.tb_login;
show tables