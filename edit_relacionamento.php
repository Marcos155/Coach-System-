<?php
  ...
  if(!empty($_GET['cod']))
  {
    ...
    if($result->num_rows > 0)
    {
        ...
        header('Location: testando_relacionamento.php');
    }
  }
  else
  {
...
<body className='snippet-body' style="background-color:#f8f9fa">
  ...
  <body id="body-pd">
    ...
    <div class="height-100 bg-light">
      <br><br>
      <h2><?php echo $nome ?>, edite aqui sua meta para relacionamentos para daqui a 12 meses &#128578;</h2><br>
      <?php
        //echo"<form action='show_sistema_forms.php?cod=$user_data[cod]' method='post'>";
        echo"<form action='save_edit_relacionamento.php' method='post' name='forms'>";
      ?>
      <div class="mb-3">
