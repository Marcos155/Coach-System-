...
if (isset($_POST['submit'])) {
  ...
  $resultSaude= mysqli_query($conexao_formsSaude,"INSERT INTO trabalho_12_meses(oque,porquem,onde,quando,porque,como,nome,sobrenome,objet,'option',responsa,data_inicio,data_fim,obs) 
