...
<body className='snippet-body' style="background-color:#f8f9fa">
  <body id="body-pd">
    ...
    <main class="mdl-layout__content">
        ...
        <p style="color:#000;">cadastro de metas em relação à saude</b></p>
        <?php
        ...
        <dialog>
          <h2 id='titulo_dialog'>Meta sobre saude</h2>
            <?php //echo "<p>$meta</p>"; ?>
...
function eliminaMeta2 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta2saude.php?cod=<?php echo $cod?>";
...
function eliminaMeta3 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta3saude.php?cod=<?php echo $cod?>";
...
function eliminaMeta4 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta4saude.php?cod=<?php echo $cod?>";
...
function eliminaMeta5 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta5saude.php?cod=<?php echo $cod?>";
