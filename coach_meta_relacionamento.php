...
function eliminaMeta2 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta2Relacionamento.php?cod=<?php echo $cod?>";
...
function eliminaMeta3 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta3Relacionamento.php?cod=<?php echo $cod?>";
...
function eliminaMeta4 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta4Relacionamento.php?cod=<?php echo $cod?>";
...
function eliminaMeta5 (el){
    var confirma =confirm("Tem a certeza que quer eliminar a Meta?");
    if (confirma==true){
        window.location.href="http://localhost/Coach-System-/delete_meta5Relacionamento.php?cod=<?php echo $cod?>";
