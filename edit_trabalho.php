<?php
  ...
  if(!empty($_GET['cod']))
  {
    ...
    if($result->num_rows > 0)
    {
        ...
        header('Location: testando_trabalho.php');
    }
  }
  else
  {
  ...
  if(isset($_POST['submit']))
  {
    ...
    $result= mysqli_query($conexao_forms15, "INSERT INTO trabalho_12_meses(mot_edit) 
    VALUES ('$mot_edit')");
    
    header('Location:edit_trabalho.php');
  }
?>
<!doctype html>
<html>
...
<body className='snippet-body' style="background-color:#f8f9fa">
  ...
  <body id="body-pd">
    ...
    <div class="height-100 bg-light">
      <br><br>
      <h2><?php echo $nome ?>, edite aqui sua meta de trabalho para daqui a 12 meses &#128578;</h2><br>
      <?php
        //echo"<form action='show_sistema_forms.php?cod=$user_data[cod]' method='post'>";
        echo"<form action='save_edit_trabalho.php' method='post' name='forms'>";
      ?>
      <div class="mb-3">
...
<div class="mb-3">
  ...
  var desc_porque = document.querySelector("#porque");
   ...
   var desc = document.querySelector("#mot_edit");
    ...
    var confirma =confirm("<?php echo $nome ?> certeza que deseja encerrar a sessão?");
    if (confirma==true){
